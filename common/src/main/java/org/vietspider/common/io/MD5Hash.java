...
public class MD5Hash {
  ...
  public MD5Hash() { this.digest = new byte[DATA_LENGTH]; }

  public MD5Hash(String hex) { setDigest(hex); }
  ...
  public Comparator<MD5Hash> getComparator() { return COMPARATOR; }
  
  /** A WritableComparator optimized for MD5Hash keys. */
  public static class MD5HashComparator implements Comparator<MD5Hash> {
    public int compare(MD5Hash arg0, MD5Hash arg1) {
  ...
  public static MD5Hash digest(String text) {
    byte[] digest;
